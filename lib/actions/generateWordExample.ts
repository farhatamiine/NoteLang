...
export async function generateWordExamples(input: AiInput): Promise<GeneratedExamplesPayload> {
    ...
    const system = [
        ...
        `Include:`,
        `- 3 sentences in ${targetLang} ("learning") with a ${nativeLang} translation ("native") dont put . at the end of the sentence.`,
